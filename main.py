...
def main() -> int:
    ...
    print (f"Day 10 - Part 1: {days.day10.part1(data)} - Part 2: {days.day10.part2(data)}")
    ...
    # data = support.support.read_day_data(17)
    # print (f"Day 17 - Part 1: {days.day17.part1(data)} - Part 2: {days.day17.part2(data)}")
    # data = support.support.read_day_data(18)
    # print (f"Day 18 - Part 1: {days.day18.part1(data)} - Part 2: {days.day18.part2(data)}")
    # data = support.support.read_day_data(19)
    ...
    # print (f"Day 24 - Part 1: {days.day24.part1(data)} - Part 2: {days.day24.part2(data)}")
    # data = support.support.read_day_data(25)
    # print (f"Day 25 - Part 1: {days.day25.part1(data)} - Part 2: {days.day25.part2(data)}")
    return 0
